<template>
  <div class="flex flex-col items-center justify-center min-h-screen p-8 bg-incognitee-blue text-white">
    <div class="max-w-md w-full bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-700">
      <div v-if="isLoading" class="flex flex-col items-center">
        ...
        <p class="text-gray-400">Please wait while we verify your payment and issue your credits.</p>
      </div>
      ...
      <div v-else-if="isSuccess" class="flex flex-col items-center">
        ...
        <p class="text-gray-300 mb-4">Your credits have been added to your wallet.</p>
        ...
        <div class="bg-gray-700 p-4 rounded-lg w-full mb-6">
          ...
          <div class="flex justify-between">
            ...
            <span class="text-green-400 font-semibold">{{ totalCredits }} credits</span>
          </div>
        </div>
      ...
      <div v-else class="flex flex-col items-center">
        ...
        <p class="text-gray-300 mb-6">{{ errorMessage || 'There was an issue verifying your payment. Please try again or contact support.' }}</p>
...
console.log('Returning to chat with address:', address, 'and network:', network);
...
onMounted(async () => {
  ...
  if (!accountStore.isConnected && !seed && !address) {
    ...
    errorMessage.value = 'No wallet connected. Please connect your wallet and try again.';
    return;
  }
