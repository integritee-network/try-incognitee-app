<template>
  <NetworkSelector :openAssetsInfo="() => { }" :selectedNetwork="shieldingTarget" />
  ...
  <div class="flex-1 overflow-y-auto bg-gray-900 mt-5 rounded-md">
    <table class="w-full whitespace-nowrap text-left">
      <tbody class="divide-y divide-white/10">
        <tr v-for="(voucher, index) in allVouchers" :key="index" class="flex justify-between">
          ...
          <td class="py-4 pl-0 pr-4 text-right text-sm/6 text-white sm:table-cell sm:pr-6 lg:pr-8">
            <!-- Desktop Ansicht -->
            <div class="flex items-center gap-4">
              <svg @click="showVoucher(voucher)" viewBox="0 0 24 24" fill="currentColor" class="size-5">
              ...
              <svg @click="openDeleteModal(voucher)" viewBox="0 0 24 24" fill="currentColor" class="size-5">
                <path fill-rule="evenodd"
        ...
        <div
          ...
          <div class="sm:flex sm:items-start">
            <div
              ...
              <svg class="size-6 text-green" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          ...
          <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
            <button @click="confirmDeleteVoucher" type="button"
  ...
  <OverlayDialog :show="showCreateVoucher" :close="closeCreateVoucher" title="Create new Voucher">
    <div class="mt-5">
    ...
    <form class="mt-5" @submit.prevent="submitSendForm">
      ...
      <div class="relative flex items-center rounded-lg">
        <textarea id="messages" v-model="sendPrivateNote" rows="2" ref="messageTextarea" name="messages"
          placeholder="Enter a private note for the recipient" :maxlength="140"
          class="w-full text-sm rounded-lg flex-grow py-2 bg-cool-900 text-white placeholder-gray-500 border border-transparent hover:border-incognitee-green focus:border-incognitee-blue truncate-input"></textarea>
      </div>
  ...
  <OverlayDialog :show="showShareVoucher" :close="closeShareVoucher" title="Share Voucher">
    ...
    <div class="flex flex-col mt-5">
      ...
      <div class="relative flex items-center rounded-lg">
        <input id="voucherAddress" type="text" :value="selectedVoucher?.url" readonly
