<template>
  <div class="container">
    <header class="header bg-gray-800 text-white py-1">
      <div class="header-content mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="text-white text-sm cursor-pointer" @click="emitAddressClicked">
    ...
    <footer class="footer">
      <nav class="footer-content mt-10 container mx-auto">
        <div class="container">
          <div class="flex mt-10 fixed left-0 right-0 bottom-10 mb-2 w-full px-4 rounded justify-around z-20">
            <div class="container custom-border-gradient">
              <div class="inner-box">
                <div class="flex justify-around text-white">
                  ...
                  <div class="flex flex-col items-center text-center">
                    <nuxt-link :to="{ path: '/messages', query: $route.query }">
