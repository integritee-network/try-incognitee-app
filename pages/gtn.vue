<template>
  <div class="container">
    <div
      ...
      <div class="w-full lg:w-4/5">
        <div class="mx-auto max-w-2xl lg:text-left">
          ...
          <p class="mt-6 text-gray-300">
            Join our new Incognitee based Guess the number giveaway contest and get the chance to win the weekly price.
            Are you able to guess the next randomly chosen number?​
          </p>
        </div>
      ...
      <!-- Other content -->
      <div class="lg:pr-4">
        <p class="text-xl font-bold tracking-tight text-white sm:text-xl text-center mb-5">
          Weekly prices:​
        </p>
        <div class="mx-auto max-w-2xl">
          <dl class="grid grid-cols-1 gap-x-8 gap-y-2 lg:gap-y-16 lg:grid-cols-1">
            <div class="flex flex-col">
              <img class="col-span-1 h-40 lg:col-span-1" src="/img/index/prizes/500teer.svg" alt="prize1" />
            </div>
          </dl>
        </div>
      </div>
    ...
    <div class="my-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="flex items-center">
          <div class="flex-1">
            ...
            <p class="mt-4 text-gray-300">
              Guess the Number is the first productive deployment of core Incognitee functionalities on the Integritee
              Network. You can now either start transferring TEER on the Integritee Network privately, or you can
              participate in the Guess the Number giveaway contest and earn one of the weekly prices.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="flex items-center">
          <div class="flex-1">
            ...
            <ul class="list-disc list-outside text-gray-300 mt-6 px-4">
              <li>The Guess the Number contest includes some core functionalities that we want to first test on our own
                Integritee Network before deploying it to Kusama or Polkadot.</li><br>
              <li>
      ...
      <div
        ...
        <div class="flex">
          <div class="flex-1">
            <h1 class="title text-3xl font-bold tracking-tight text-white sm:text-4xl text-left">
              How to participate?​​
            </h1>
            <p class="mt-6 text-gray-300">
              ...
              <a class="text-incognitee-green"
                href="https://www.kraken.com/prices/integritee?quote=usd&interval=24h">Kraken</a>, <a
                class="text-incognitee-green" href="https://www.gate.io/de/trade/TEER_USDT">Gate</a> or
              <a class="text-incognitee-green"
                href="https://app.basilisk.cloud/trade?assetIn=1&assetOut=17">Basilisk</a>​<br />
              2. Go to the Incognitee Wallet​
              ​<br />
      ...
      <div
        ...
        <div class="flex items-center">
          <div class="flex-1">
            ...
            <ul class="list-disc list-outside text-gray-300 mt-6 px-4">
              <li> The contest runs on a weekly basis and always starts on Monday at 2 pm CET​​</li>
              <li> A random number between 1 and 10’000 will be generated by our randomness oracle which will be the
                reference number​​</li>
              <li>
                You can enter up to 10 numbers per week​
              </li>
              <li>
                The one who enters a number that is the closest to the randomly chosen one, will win​
              </li>
              <li>
                If multiple participants are guessing the same number and win, the prize will be equally split between
                those participants
              </li>
            </ul>
          </div>
