...
<div
  ...
  <div class="mt-5">
    ...
    >
      ...
      <div
        class="currency-box gap-2 p-3 basis-1/4 border-2 border-incognitee-green"
      >
                ...
                <div class="mt-3 text-center sm:mt-5">
                  ...
                  <div class="mt-2">
                    ...
                    <p class="text-sm text-gray-400 text-left my-4">
                      With further extension, Incognitee will be able to shield
                      BTC, ETH and any other token whose protocol supports light
                      clients
                    </p>
                  </div>
                </div>
              ...
              <div class="mt-3 text-center sm:mt-5">
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-400 mt-4 text-justify">
                    Incognitee enhances your privacy while dealing with digital
                    assets. But what does privacy mean and how does incognitee
                    improve privacy?
                  </p>
                  <p class="text-sm text-gray-400 text-justify my-4">
                    ...
                    account is a pseudonym on a public ledger, much like a bank
                    account number. Every single transaction this account does
                    will be stored publicly forever and you have no right for
                    deletion of the trace you left. If, at a certain point in
                    time your pseudonym can be linked to your identity - i.e.
                    because you send tokens to someone else - your entire
                  ...
                  <p class="text-sm text-gray-400 text-justify my-4">
                    ...
                    is a privacy enhancing technology that allows you to shield
                    your assets and transfer them privately. This means that you
                    can send tokens to someone else without revealing your
                    balance or transaction history. The recipient will not be
                    able to see your balance or transaction history either. This
                    is achieved by using a technology called
                    <NuxtLink
                    ...
                    , a Polkadot parachain, performs independent, decentralized
                    remote attestation of TEEs. Moreover, it gives finality to
                    Incognitee sidechain blocks.
                  </p>
                  <p class="text-sm text-gray-400 mt-4 text-justify">
                    Incognitee is a layer 2 solution, maintaining a private
                    ledger secured by TEE. All your transactions are
                    confidential, only known to and the person your transacting
                    with. Sender, recipient and amount are invisible to the
                    public and even to the operators of Incognitee
                    infrastructure.
                  </p>
                  <p class="text-sm text-gray-400 mt-4 text-justify">
                    ...
                    benefit from k-anonymity: the public just sees that someone
                    out of <i>k</i> individuals is the originator of an
                    unshielding event. If <i>k</i> is large enough, you can
              ...
              <div class="mt-3 text-center sm:mt-5">
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-400">
                    ...
                    copy-paste your address and solve a CAPTCHA to get free PAS
                    tokens
                  </p>
            ...
            <div class="mt-3 text-center sm:mt-5">
              ...
              <form class="mt-5" @submit.prevent="submitUnshieldForm">
                ...
                <p class="text-sm text-gray-400 text-left mt-5">
                  ...
                  PAS at the time. In the future we will provide a score
                  including timing and popular amounts to enhance unlinkability
                  of your actions.
                </p>
          ...
          >
            ...
            <div class="flex-grow flex flex-col justify-start">
              ...
              <div class="mt-3 text-center sm:mt-5">
                ...
                <div class="mt-5">
                  <p class="text-sm text-gray-400 text-left my-4">
                    Share your address with the sender. You can either have them
                    scan this QR code or send them a private message.
                  </p>
                </div>
          ...
          >
            ...
            <div class="flex-grow">
              <div class="mt-3 text-center sm:mt-5">
                ...
                <div class="mt-5">
                  <p class="text-sm text-gray-400 text-left my-4">
                    Sending privately means that only you and the recipient know
  ...
  <TransitionRoot as="template" :show="showGuessTheNumberOverlay">
    <Dialog class="relative z-50" @close="closeGuessTheNumberOverlay">
      <TransitionChild
        as="template"
        enter="ease-out duration-300"
        enter-from="opacity-0"
            ...
            <div>
              ...
              <div class="mt-3 text-center sm:mt-5">
                ...
                <div class="mt-2">
                  ...
                  <p class="text-sm text-gray-400 mt-4 text-left">
                    In order to keep your wallet, please store a bookmark to the
                    current url which includes your secret
            ...
            <div>
              ...
              <div class="mt-3 text-center sm:mt-5">
                ...
                <div class="mt-2">
                  ...
                  <div v-if="accountStore.hasInjector" class="mt-5">
                    <p class="text-sm text-gray-400">
