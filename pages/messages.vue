    ...
    <table class="w-full whitespace-nowrap text-left">
      <tbody class="divide-y divide-white/10">
        <tr class="flex flex-wrap sm:flex-nowrap justify-between">
          ...
          <td
            class="flex items-center gap-x-4 py-4 pl-4 pr-8 sm:pl-6 lg:pl-8 w-full sm:w-auto"
          >
            <svg
          ...
          <td
            class="w-full sm:w-auto py-4 pl-4 sm:pl-0 pr-8 sm:pr-4 text-left text-sm text-white"
          >
            <div class="break-words whitespace-normal">
              Hi there! Just checking in to see how everything is going. Let me
              know if you need any help with the tasks at hand or if there’s
    ...
    <div class="mt-5">
      ...
      <div>
        <input
          ...
          type="text"
          disabled
          value="2Pm7Rdfjansfjkabgh435346bdfasdf"
