  ...
  <div class="py-24 sm:py-32 container">
      ...
      >
        <div class="mx-auto w-full max-w-xl lg:mx-0">
          ...
          <p class="mt-6 text-gray-300">
            Collect TEERdays now and get the pole position for the Incognitee
            Go-Live. Collect TEERdays now and get the pole position for the
            Incognitee Go-Live. Collect TEERdays now and get the pole position
            for the Incognitee Go-Live. Collect TEERdays now and get the pole
            position for the Incognitee Go-Live.​
          </p>
          <div
          ...
          <div v-if="accounts.length < 1" class="mt-10 flex">
            <button
              @click="connect"
              class="incognitee-bg rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
            >
              Connect Wallet
            </button>
          </div>
    ...
    <div class="py-10">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-none">
          <h1
            class="title mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl"
          >
            TEERdays Statistics
          </h1>
          <dl
    ...
    <div
      class="relative isolate overflow-hidden px-6 py-5 sm:py-5 lg:overflow-visible lg:px-0"
    >
      <div
        class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10"
      >
    ...
    <div
      class="relative isolate overflow-hidden py-20 lg:overflow-visible lg:px-0"
    >
      <div
        class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10"
      >
