                    ...
                    <div class="mt-10">
                      ...
                      <div>
                        <input
                          ...
                          "
                          required
                          class="w-full rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-600 placeholder:text-gray-400 sm:text-sm sm:leading-6" placeholder="Amount"
                        />
                      </div>
